...
$checks=array(
 ...
 array($lock,'codex/file02-modern-auth-24-1.4.0','release lock does not name the current Modern Authentication 24 branch'),
 array($lock,'"release_version": "1.4.0"','release lock does not identify the current 1.4.0 runtime'),
 array($lock,'"database_version": "1.4.0"','release lock does not identify the current additive DB migration identity'),
 ...
 array($lock,'"review_line": "X24-modern-authentication-24"','release lock does not bind the current correction to Modern Authentication 24'),

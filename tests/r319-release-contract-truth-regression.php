...
$checks=array(
 ...
 array($lock,'codex/file02-modern-auth-24-1.4.0','release lock does not name the current R341 legacy-email reconciliation branch'),
 array($lock,'"release_version": "1.4.0"','release lock does not identify the current 1.3.4 runtime'),
 array($lock,'"database_version": "1.4.0"','release lock changed the canonical DB identity unexpectedly'),

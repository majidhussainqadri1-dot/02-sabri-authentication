...
$checks=array(
 ...
 array($lock,'fix/file02-passkey-assurance-cycle-1.3.3-2026-08-19','release lock does not name the current R340 passkey-assurance cycle correction branch'),
 array($lock,'"release_version": "1.3.3"','release lock does not identify the current 1.3.3 runtime'),

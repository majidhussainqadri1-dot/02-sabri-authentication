...
$checks=array(
 ...
 array($lock,'fix/file02-passkey-index-reconciliation-1.2.6','release lock names stale review line'),
 ...
 array($manifest,'fix/file02-passkey-index-reconciliation-1.2.6','release manifest names stale review line'),

...
$req( empty( $lock['cross_file_blockers'] ) && 31850253635 === (int) ( $integration_evidence['workflow_run_id'] ?? 0 ), 'cross-file blocker closure lacks exact successful integration evidence' );
$req( 'f740ca65fc33031b98d7d75e5f27b7ccbeeefbf9' === (string) ( $integration_evidence['file02_sha'] ?? '' ), 'paired File 02 integration SHA evidence stale' );

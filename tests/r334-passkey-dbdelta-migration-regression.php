...
$req( is_array( $lock ) && '1.3.1' === ( $lock['release_version'] ?? '' ), 'release lock runtime stale' );
$req( 'fix/file02-live-passkey-user-status-index-1.3.1' === ( $lock['candidate_branch'] ?? '' ), 'release lock branch stale' );
...
$req( false !== strpos( $integration, "FILE00_VERSION: '1.2.44'" ) && false !== strpos( $integration, "FILE02_VERSION: '1.3.1'" ), 'paired integration identities stale' );

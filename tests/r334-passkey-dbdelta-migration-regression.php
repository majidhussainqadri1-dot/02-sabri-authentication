...
$req( '1.4.0' === (string) ( $integration_evidence['file02_runtime'] ?? '' ), 'current exact-head integration runtime identity is stale' );
...
$req( false !== strpos( $integration, "FILE00_VERSION: '1.2.44'" ) && false !== strpos( $integration, "FILE02_VERSION: '1.4.0'" ), 'paired integration identities stale' );

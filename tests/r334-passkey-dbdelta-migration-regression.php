...
$req( false !== strpos( $main, 'Version: 1.3.2' ) && false !== strpos( $main, "SAUTH_VERSION', '1.3.2" ), 'runtime identity not 1.3.2' );
...
$req( is_array( $lock ) && '1.3.2' === ( $lock['release_version'] ?? '' ), 'release lock runtime stale' );
$req( 'fix/file02-file00-canonical-routes-1.3.2-2026-08-16' === ( $lock['candidate_branch'] ?? '' ), 'release lock branch stale' );
...
$req( false !== strpos( $integration, "FILE00_VERSION: '1.2.44'" ) && false !== strpos( $integration, "FILE02_VERSION: '1.3.2'" ), 'paired integration identities stale' );

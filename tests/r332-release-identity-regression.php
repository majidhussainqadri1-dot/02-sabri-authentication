...
$req( false !== strpos( $main, 'Version: 1.4.0' ) && false !== strpos( $main, "SAUTH_VERSION', '1.4.0" ), 'runtime identity not 1.4.0' );
$req( false !== strpos( $main, "SAUTH_DB_VERSION', '1.4.0" ), 'DB identity not 1.4.0' );
...
$req( false !== strpos( $baseline, "RELEASE_VERSION: '1.4.0'" ), 'baseline workflow identity stale' );
$req( false !== strpos( $docs, "'release_version':'1.4.0'" ), 'docs workflow identity stale' );
$req( false !== strpos( $integration, "FILE02_VERSION: '1.4.0'" ) && false !== strpos( $integration, "FILE00_VERSION: '1.2.44'" ), 'real integration paired identity stale' );

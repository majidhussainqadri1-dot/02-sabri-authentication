...
$result = SA_Professional_Reauthentication::verify_and_record( 8, 'password', '123456', array( 'scope' => 'file09:review:9' ) );
...
$result = SA_Professional_Reauthentication::verify_and_record( 7, 'wrong', '123456', array( 'scope' => 'file09:review:9' ) );
...
$result = SA_Professional_Reauthentication::verify_and_record( 7, 'password', '123456', array( 'scope' => 'file09:review:9' ) );
...
$result = SA_Professional_Reauthentication::assertion( 7, 'file09:review:9' );
sa_prof_assert( 'valid' === $result['result'], 'existing session-bound assurance can be re-read' );
sa_prof_assert( false === $result['password_verified'], 'existing assertion does not falsely claim fresh password verification' );

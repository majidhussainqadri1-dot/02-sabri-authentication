...
r299_has( $plan, 'fix/file02-passkey-dbdelta-migration-1.2.5', 'traceability candidate branch is stale' );
r299_has( $status, 'fix/file02-passkey-dbdelta-migration-1.2.5', 'status candidate branch is stale' );

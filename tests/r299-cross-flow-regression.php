...
r299_has( $plan, 'fix/file02-account-taxonomy-parity-1.2.4', 'traceability candidate branch is stale' );
r299_has( $status, 'fix/file02-account-taxonomy-parity-1.2.4', 'status candidate branch is stale' );

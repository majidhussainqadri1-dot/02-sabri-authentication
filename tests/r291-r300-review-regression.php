...
r291_r300_contains( $main, "WP_Session_Tokens::get_instance( absint( $user_id ) )->destroy_all();", 'Passkey assurance epoch rotation must invalidate all WordPress sessions.' );
...
r291_r300_contains( $passkey, 'rotate_assurance_epoch', 'Passkey assurance invalidation epoch missing.' );

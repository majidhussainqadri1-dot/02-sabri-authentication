...
$fail = array();
$checks = array(
    array( $main, 'Version: 1.4.0', 'plugin header release identity stale' ),
    array( $main, "SAUTH_VERSION', '1.4.0", 'runtime release identity stale' ),
    ...
    array( $baseline, "RELEASE_VERSION: '1.4.0'", 'baseline release workflow version stale' ),

...
$fail = array();
$checks = array(
    array( $main, 'Version: 1.3.4', 'plugin header release identity stale' ),
    array( $main, "SAUTH_VERSION', '1.3.4", 'runtime release identity stale' ),
    array( $main, "SAUTH_DB_VERSION', '1.3.0", 'DB identity unexpectedly changed' ),
    array( $lock, '"release_version": "1.3.4"', 'release lock runtime stale' ),
    array( $lock, 'fix/file02-legacy-email-verification-reconciliation-1.3.4', 'release lock branch stale' ),
    ...
    array( $readme, 'Stable tag: 1.3.4', 'WordPress stable tag stale' ),
    array( $readme, '= 1.3.4 =', 'WordPress changelog omits current R341 correction' ),
    ...
    array( $baseline, "RELEASE_VERSION: '1.3.4'", 'baseline release workflow version stale' ),
    ...
    array( $baseline, 'tests/r341-email-verification-legacy-reconciliation-regression.php', 'baseline release workflow does not require R341' ),
    ...
    array( $integration, '738aa2ab4b8be3d6cfdb3ecd46c88aa8d9ece3a0', 'integration workflow is not exact-pinned to current File00 1.2.44 main' ),
    ...
    array( $integration, 'Prove R341 legacy verified-email reconciliation against current File 00', 'integration lacks current R341 legacy reconciliation proof' ),

...
$req( '1.3.1' === (string) ( $lock['release_version'] ?? '' ) && '1.3.0' === (string) ( $lock['database_version'] ?? '' ) && '1.0.1' === (string) ( $lock['passkey_schema_version'] ?? '' ), 'current release/schema identity is stale' );
...
$req( false === ( $lock['live_1_3_0_activation_incident']['live_resolution_claimed'] ?? true ), 'live incident was falsely marked resolved before deployment/retest' );

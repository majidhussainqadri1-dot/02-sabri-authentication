...
<main class="sa-auth-shell">
	<section class="sa-auth-card" aria-labelledby="sa-google-verify-title">
		...
		<div class="sa-notice sa-notice-error">This older Authenticator/recovery-code step belonged to a retired File 00 MFA workflow. Current Google sign-in uses verified Google OIDC directly; Google link and unlink changes require a fresh File 02 passkey instead.</div>

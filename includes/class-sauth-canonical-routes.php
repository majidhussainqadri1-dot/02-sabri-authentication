...
final class SAUTH_Canonical_Routes {
	...
	public static function register() {
		add_rewrite_rule( '^account/sessions/?
	...
	public static function render() {
		...
		$shortcode = self::SESSIONS === $route ? '[sabri_auth_sessions]' : ( self::SECURITY === $route ? '[sabri_auth_security_center]' : '[sabri_auth_collision_resolution]' );
		get_header();
...
, 'index.php?' . self::QUERY_VAR . '=' . self::SESSIONS, 'top' );
		add_rewrite_rule( '^account-security/?
		if ( SAUTH_VERSION !== (string) get_option( 'sauth_rewrite_version', '' ) ) {
			flush_rewrite_rules( false );
			update_option( 'sauth_rewrite_version', SAUTH_VERSION, false );
		}
...
, 'index.php?' . self::QUERY_VAR . '=' . self::SECURITY, 'top' );
		add_rewrite_rule( '^resolve-account/?
		if ( SAUTH_VERSION !== (string) get_option( 'sauth_rewrite_version', '' ) ) {
			flush_rewrite_rules( false );
			update_option( 'sauth_rewrite_version', SAUTH_VERSION, false );
		}
...
, 'index.php?' . self::QUERY_VAR . '=' . self::RESOLVE, 'top' );
		add_rewrite_rule( '^\\.well-known/webauthn/?
		if ( SAUTH_VERSION !== (string) get_option( 'sauth_rewrite_version', '' ) ) {
			flush_rewrite_rules( false );
			update_option( 'sauth_rewrite_version', SAUTH_VERSION, false );
		}
...
, 'index.php?' . self::QUERY_VAR . '=' . self::RELATED_ORIGIN, 'top' );
		if ( SAUTH_VERSION !== (string) get_option( 'sauth_rewrite_version', '' ) ) {
			flush_rewrite_rules( false );
			update_option( 'sauth_rewrite_version', SAUTH_VERSION, false );
		}

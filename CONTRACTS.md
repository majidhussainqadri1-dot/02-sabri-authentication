# File 02 Contract Register — Version 1.4.0 Addendum

New additive contracts: `sauth.modern-auth 1.0.0`, Authentication Assurance Receipt v2 `2.0.0`, and Shared Signals `1.0.0`. Existing `smc_file02_authentication_assurance_v1 1.0.0` remains backward-compatible. External DPoP/FIDO/FedCM/credential-exchange verifiers are deliberately fail-closed when not configured.

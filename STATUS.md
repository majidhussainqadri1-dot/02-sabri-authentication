# File 02 Status — Version 1.2.5

## Current candidate

- Branch: `fix/file02-passkey-dbdelta-migration-1.2.5`
- Version/schema: `1.2.5 / 1.2.1`; passkey table schema `1.0.1`
...
- File 02 1.2.5 retains the 1.2.1 storage-router bootstrap correction and adds R321–R330 fail-closed, migration/index, passkey, provider, privacy, session, UI and release-truth hardening.

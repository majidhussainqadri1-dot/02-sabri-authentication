# File 02 — Release Manifest — 1.2.5

## Release identity

- Module: `02 — Authentication and Accounts`
- Candidate version/schema: `1.2.5 / 1.2.1`
- Passkey schema/assurance: `1.0.1 / 1.0.0`
- Candidate branch: `fix/file02-passkey-dbdelta-migration-1.2.5`
...
- Package: `02-sabri-authentication-1.2.5-SOURCE-CANDIDATE.zip`
- Manifest: `02-sabri-authentication-1.2.5-MANIFEST.json`
...
7. build the 1.2.5 package twice from a fixed source epoch and prove byte identity before any release claim;

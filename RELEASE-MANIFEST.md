# File 02 — Release Manifest — 1.2.4

## Release identity

- Module: `02 — Authentication and Accounts`
- Candidate version/schema: `1.2.4 / 1.2.1`
...
- Package: `02-sabri-authentication-1.2.4-SOURCE-CANDIDATE.zip`
- Manifest: `02-sabri-authentication-1.2.4-MANIFEST.json`
...
7. build the 1.2.4 package twice from a fixed source epoch and prove byte identity before any release claim;

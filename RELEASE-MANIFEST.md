# File 02 — Release Manifest — 1.2.3

## Release identity

- Module: `02 — Authentication and Accounts`
- Candidate version/schema: `1.2.3 / 1.2.1`
- Passkey schema/assurance: `1.0.1 / 1.0.0`
- Candidate branch: `review/file02-r321-r330-2026-08-14`
...
- Package: `02-sabri-authentication-1.2.3-SOURCE-CANDIDATE.zip`
- Manifest: `02-sabri-authentication-1.2.3-MANIFEST.json`
...
7. build the 1.2.3 package twice from a fixed source epoch and prove byte identity before any release claim;
